...
//            }
    ...
    public function getTiempoSinComerAction(Request $request) {
        ...
        $TIEMPO_DEFECTO = $doctrine->getRepository('AppBundle:Constante')->findOneByClave('tiempo_acabar_de_comer');

        $tsc = $USUARIO->getTiempoSinComer();
        if ($tsc === null) {
            return new JsonResponse(array('tiempo_sin_comer' => 'null'), 200);
        }
